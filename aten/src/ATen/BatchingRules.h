...
inline std::pair<Tensor,BatchDims> unary_pw_batching_rule(const Tensor& self, BatchDimsRef self_bdims) {
  return { Op(self), { self_bdims.begin(), self_bdims.end() } };
}

std::pair<Tensor,BatchDims>
inline dropout_batching_rule(const Tensor& self, BatchDimsRef self_bdims, double p, bool train) {
  return { at::dropout(self, p, train), { self_bdims.begin(), self_bdims.end() } };
}

inline std::pair<Tensor,BatchDims> conv2d_batching_rule(
  ...
  auto input_ = moveBatchDimsToFront(input, input_bdims);
  auto result_bdims = moveBatchDimsToFront(input_bdims);
...
inline std::pair<Tensor,BatchDims> transpose_batching_rule(
    const Tensor& self, BatchDimsRef self_bdims,
...
inline std::pair<Tensor,BatchDims> squeeze_dim_batching_rule(
    const Tensor& self, BatchDimsRef self_bdims,
    int64_t dim) {
  auto self_ = moveBatchDimsToFront(self, self_bdims);
  auto result_bdims = moveBatchDimsToFront(self_bdims);
...
inline std::pair<Tensor,BatchDims> unsqueeze_batching_rule(
    const Tensor& self, BatchDimsRef self_bdims,
    int64_t dim) {
  auto self_ = moveBatchDimsToFront(self, self_bdims);
  auto result_bdims = moveBatchDimsToFront(self_bdims);
...
inline std::pair<Tensor,BatchDims> permute_batching_rule(
    const Tensor& self, BatchDimsRef self_bdims,
    IntArrayRef dims) {
  auto self_ = moveBatchDimsToFront(self, self_bdims);
  auto result_bdims = moveBatchDimsToFront(self_bdims);
...
inline std::pair<Tensor,BatchDims> reshape_batching_rule(
    const Tensor& self, BatchDimsRef self_bdims,
    IntArrayRef shape) {
  auto self_ = moveBatchDimsToFront(self, self_bdims);
  auto result_bdims = moveBatchDimsToFront(self_bdims);
...
inline std::pair<Tensor,BatchDims> view_batching_rule(
    const Tensor& self, BatchDimsRef self_bdims,
    IntArrayRef size) {
  auto self_ = moveBatchDimsToFront(self, self_bdims);
  auto result_bdims = moveBatchDimsToFront(self_bdims);
...
inline std::pair<Tensor,BatchDims> select_batching_rule(
    const Tensor& self, BatchDimsRef self_bdims,
...
inline std::pair<Tensor,BatchDims> index_batching_rule(
...
inline std::pair<std::vector<Tensor>,BatchDims> chunk_batching_rule(
...
inline std::vector<int64_t> computeIndex(int64_t linear_idx, IntArrayRef sizes) {
...
//   auto self_ = moveBatchDimsToFront(self, self_bdims);
//   auto result_bdims = moveBatchDimsToFront(self, self_bdims);
